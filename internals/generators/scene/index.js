...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/tests/index.test.js',
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/actions.js',
        templateFile: './scene/actions.js.hbs',
        abortOnFail: true
      })
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/tests/actions.test.js',
      ...
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/constants.js',
      ...
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/tests/selectors.test.js',
      ...
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/reducer.js',
        templateFile: './scene/reducer.js.hbs',
        abortOnFail: true
      })
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/tests/reducer.test.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/saga.js',
        templateFile: './scene/saga.js.hbs',
        abortOnFail: true
      })
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/tests/saga.test.js',
    ...
    if (data.wantLoadable) {
      actions.push({
        type: 'add',
        path: '../../src/scenes/{{properCase name}}/Loadable.js',
