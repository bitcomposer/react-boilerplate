  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/index.js',
      ...
      },
      {
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/tests/index.test.js',
    ...
    if (data.wantMessages) {
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/messages.js',
        templateFile: './subScene/messages.js.hbs',
        abortOnFail: true,
      });
    }
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/actions.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/tests/actions.test.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/constants.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/selectors.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/tests/selectors.test.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/reducer.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/tests/reducer.test.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/saga.js',
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/tests/saga.test.js',
    ...
    if (data.wantLoadable) {
      actions.push({
        type: 'add',
        path:
          '../../app/scenes/{{properCase sceneName}}/scenes/{{properCase name}}/Loadable.js',
